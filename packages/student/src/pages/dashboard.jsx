...
export function Dashboard(props) {
  const limit = 16;
  const { dashboard, refetch, searchLoading, searchKeyword, searchSectionData } = props;
  const {
    accessToken,
    role,
    packId,
            ...
            >
              ...
              { isFilter ? (
                <div className="row mt-4" style={ { minHeight: "400px" } }>
                  { loading && <div className="col-sm-12 text-center p-5">
                    <h2>Loading...</h2>
                  </div>
                  }
                  { !loading && filterData &&
                ...
                <>
                  { " " }
                  { searchLoading && <div className="col-sm-12 text-center p-5">
                    <h2>Loading...</h2>
                  </div>
                  }
                  { !searchLoading && 
                  ...
                  searchSectionData.length == 0 && (
                    <div>
                      <div className="card custom-card px-4 py-4 mt-4">
                        <h4 className="dash-card-heading mb-4 d-flex 12">
                          <img className="pr-2" src="/static/media/videos_blue.8ebd723c.svg" alt="" />
                          Search Results
                        </h4>
                        <h2>No Result Found</h2>
                      </div>
                  ...
                  { !searchLoading && searchSectionData?.length > 0 && (
                    <SliderComponent
