...
function moveForward() {
  ...
  switch (currentExerciseID) {
    ...
    case EXERCISE_RECORD_RETELL_STORY:
      this.setState({ exerciseIndex: parseInt(exerciseIndex) + 1, questionIndex: 0 })
      break;
    ...
    case EXERCISE_LONG_ANSWER:
      if (parseInt(questionIndex)+ 1 < currentExercise.questions.length)
        this.setState({ questionIndex: parseInt(questionIndex) + 1 })
      else
        this.setState({ exerciseIndex: parseInt(exerciseIndex) + 1, questionIndex: 0 })
      break;
  }
